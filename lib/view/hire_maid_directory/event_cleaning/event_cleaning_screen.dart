...
class _EventCleaningServiceScreenState
  ...
  AppLists eventTileList = AppLists();
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                itemCount: eventTileList.eventTilesData.length,
                itemBuilder: (BuildContext context, int index) {
                  final Map<String, dynamic> tileData =
                      eventTileList.eventTilesData[index];
                  final String imagePath = tileData['imagePath'];
                  final String foodType = tileData['serviceType'];
                  final isSelected = eventSelectedTiles.containsKey(foodType)
                      ? eventSelectedTiles[foodType]!
                      : false;
                  ...
                  return FoodTypeTile(
                    ...
                    onChanged: (bool? value) {
                      setState(() {
                        eventSelectedTiles[foodType] = value ?? false;
                      });
                    },
                  );
                },
